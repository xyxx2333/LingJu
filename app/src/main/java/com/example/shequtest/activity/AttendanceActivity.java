...
import com.example.shequtest.module.Attendance;
...
//        上次签到时间
        ...
        text4 = (TextView) findViewById(R.id.layoutqiandaoTextView2);
                ...
                if (t1.equals(t2)) {
                    ...
                    attendance.save(new SaveListener<String>() {
                        ...
                        public void done(String s, BmobException e) {
                            if (e == null) {
                                Toast.makeText(AttendanceActivity.this, "签到成功 积分+10金币+1", Toast.LENGTH_SHORT).show();
                                text2.setText(str1);
                                button.setText("已签到");
    ...
    public void huoqu() {
        ...
        query.findObjects(new FindListener<Attendance>() {
            ...
            public void done(List<Attendance> attendances, BmobException e) {
                if (e == null) {
                    if (attendances.size() == 0) {
                        Toast.makeText(AttendanceActivity.this, "签到有积分和金币噢", Toast.LENGTH_SHORT).show();//弹出成功的提示
                    }
                    else {
                ...
                if (e == null) {
                    if (myUsers.size() == 0) {
                        ...
                        for (MyUser myUser : myUsers) {
                            ...
                            text4.setText(myUser.getJinbi().toString());
