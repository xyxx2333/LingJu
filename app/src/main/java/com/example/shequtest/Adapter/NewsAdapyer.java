...
import com.example.shequtest.activity.WebViewActivity;
import com.example.shequtest.back.ImageLoadTool;
...
public class NewsAdapyer extends RecyclerView.Adapter<NewsAdapyer.ViewHodler> {
    ...
    public ViewHodler onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(context).inflate(R.layout.goods_ites_lingju,parent,false);
