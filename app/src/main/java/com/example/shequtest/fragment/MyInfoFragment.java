...
import com.example.shequtest.activity.AttendanceActivity;
import com.example.shequtest.activity.FeedBackActivity;
import com.example.shequtest.activity.SettingActivity;
import com.example.shequtest.activity.UserProfileActivity;
import com.example.shequtest.module.MyUser;
import com.example.shequtest.module.Topic;
...
public class MyInfoFragment extends Fragment {
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        text6 = (TextView) getActivity().findViewById(R.id.fg2textview3);//金币
                ...
                if (e == null) {
                    if (myUsers.size() == 0) {
                        ...
                        for (MyUser p1 : myUsers) {
                            ...
                            text6.setText(p1.getJinbi().toString());
