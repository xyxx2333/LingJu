...
import com.example.shequtest.activity.PostDetailActivity;
import com.example.shequtest.activity.PostTopicActivity;
import com.example.shequtest.module.Comment;
...
public class CommunityFragment extends Fragment {
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        Bmob.initialize(getActivity(), "a2f0cb5fa25b26e579c32b844221a9a3");
        user = new MyUser();
//        获取当前登录用户
